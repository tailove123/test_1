...
int mat_space[5] = {0, 0, 0, 0, 100};                     // 기타 아이템 공간, max = 999
                            ...
                            else if (user_select_janbi == 1)
                            {
                                ...
                                for (int i = 0 ; i < 6 ; i++)
                                {
                                    if (MY_EQUIP[i][0] == INVEN[user_select_janbi-1][0]) // 같은 부위의 장비를 이미 장착중인 경우
                                    {
                                        ...
                                        map_change();           MY_EQUIP_tmp[0][2] = MY_EQUIP[i][2];
            ...
            while(floor != 0)     
            {
                ...
                switch (user_war_select)
                {
                    case 1:
                    {
                        ...
                        AD = ((live_atk + ((MY_EQUIP[0][2] * (MY_EQUIP[0][4] * 0.01))* (MY_EQUIP[0][5] * 0.01))) * ALLTK_PER);
                        // printf("%d",AD);
                    ...
                    case 2:
                    {
                        ...
                        AP = (( live_mtk * skill_magic_m[user_skill_select-1] ) * ALLTK_PER); // * weakness_point) ;
                        //printf("%d\n",AP);
                        
                        monster_max_hp = monster_max_hp - AP;
...
void map_print()
{
    ...
    while (plag_mapout == 0)   //전투든 메뉴든 와일문 나가는 플래그
    {
        ...
        while(map_input != '1')
        {
            ...
            if (((user_y==portal_y) && (user_x==portal_x))||((floor!=0)&&(mon_num==0)))
            {
                floor += 1;
                map_change();
                break;
